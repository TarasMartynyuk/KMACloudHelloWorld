...
function enableButtons () {
    ...
    btn = document.getElementById("input_greet_like_alien");
    btn.value = "Click me for an alien greeting";
    btn.onclick=function(){ greetLikeAlien(); }
}

function greetLikeAlien() {
    var planet = document.getElementById("planet_field").value;
    var request = gapi.client.helloworldendpoints.greetByPeriod({'planet' : planet});
